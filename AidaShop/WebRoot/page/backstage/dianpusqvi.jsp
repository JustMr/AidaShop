    ...
    <div>
    	<s:form action="upAllStoreAuthAction" method="POST">  
    		<s:hidden name="cust.UId" />  
	  		<table id="upBrtable" border="1" width="100%">
	  			<tr>
	  				<td width="15%" align="left"><label>用户名:</label></td>
	  				...
	  				<td width="15%" align="left"><label>昵称:</label></td>
			   	...
			   	<tr>
			   		<td width="15%" align="left"><label>真实姓名:</label></td>
			   		...
			   		<td width="15%" align="left"><label>性别:</label></td>
			   	...
			   	<tr>
			   		<td width="15%" align="left"><label>生日:</label></td>
			   		...
			   		<td width="15%" align="left"><label>住址:</label></td>
			   	...
			   	<tr>
			   		<td width="15%" align="left"><label>身份证:</label></td>
			   		...
			   		<td width="15%" align="left"><label>电子邮箱:</label></td>
			   	...
			   	<tr>
			   		<td width="15%" align="left"><label>手机:</label></td>
 				...
 				<tr>
					...
					<td width="15%" align="left"><label>店铺名称:</label> </td>
					<td class="upBrFont" width="35%" align="left"><s:textfield readonly="true" style= "background:transparent;border-style:none;width:100%; "  name="storeAuth.saName" label="店铺名称" /></td>
					<td align="left" width="15%"><label>店铺标签:</label></td>
			   		<td class="upBrFont" width="35%" align="left"><s:textfield readonly="true" style= "background:transparent;border-style:none;width:100%; "  name="storeAuth.saTag" label="店铺标签" /></td>
			   	</tr>  
			   	<tr>
			   	...
			   	<tr>
			   	 	<td width="15%" align="left">
					 	<label>申请状态:</label><input id="pageCheck" type="hidden" value="spsqvi" /> 
					</td>
					<td class="upBrFont" align="left" colspan="3">
