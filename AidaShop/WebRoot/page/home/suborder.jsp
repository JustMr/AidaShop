  ...
  <body>
    ...
    <div class="pubwrap">
    	<table>
			...
			<tr>
				<td><a id="paybtn" href='page/payment/bank.jsp?orderid=<s:property value="order.coName"/>&money=<s:property value="order.coRealPrice"/>'>去支付</a></td>
			</tr>
    	</table>
    </div>
