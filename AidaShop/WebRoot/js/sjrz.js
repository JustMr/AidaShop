...
function infoPost() {
	...
	if (UName==""||UNickName==""||URelaname==""||USex==""||UBirthday==""||UAddress==""||UCardId==""||UEmail==""||UMobile=="") {
		...
		$.post("upSACustomerAction",{UName:UName,UNickName:UNickName,URelaname:URelaname,USex:USex,UBirthday:UBirthday,UAddress:UAddress,UCardId:UCardId,UEmail:UEmail,UMobile:UMobile},function() {
			$("#baseCompRes").val("yes");
			$("#viewBtn p").text("修改成功！");
			formHide();
		});
